...
public class ATM_672020025 extends JFrame {
	...
	int balance = 50000;
	String[] inputSequence = new String[8];
	...
	protected void buildApp(){
		...
		JLabel displayArea = new JLabel("<html>Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: Rp." + balance + "</html>");
		...
		withDraw1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 50000){
					...
					displayArea.setText("<html>Rp.50.000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rp.50.000");
					updateTransactionHist("User Has Withdrawn Rp.50.000");
				} else {
					displayArea.setText("<html> Your Balance is below Rp.50.000. Unable to Withdraw!! <br><br>" 
		...
		withDraw2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 100000){
					...
					displayArea.setText("<html>Rp.100.000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rp.100.000");
					updateTransactionHist("User Has Withdrawn Rp.100.000");
				} else {
					displayArea.setText("<html> Your Balance is below Rp.100.000 Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
		...
		withDraw3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(balance >= 200000){
					...
					displayArea.setText("<html>Rp.200.000 Withrawn! <br><br>" + finishedTransaction() + "</html>");
					readyToEnter = false;
					System.out.println("User Has Withdrawn Rp.200.000");
					updateTransactionHist("User Has Withdrawn Rp.200.000");
				} else {
					displayArea.setText("<html> Your Balance is below Rp.200.000. Unable to Withdraw!! <br><br>" 
					+ finishedTransaction() + "</html>");
				}
			}	
		});
		...
		deposit.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
					displayArea.setText("<html> Deposit Selected! <br> Please input an amout below or equal to Rp.10.000.000 and click enter! <br><br>" 
					+ finishedTransaction() + "</html>" );
					readyToEnter = true;
			}	
		});
		...
		enter.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				if(readyToEnter == true){
					if(Integer.parseInt(getInputSequence()) > 10000000){
						displayArea.setText("That input is greater than Rp.10000000!");
						clearInput();
						inputDisplay.setText("Input Display: ");
						readyToEnter = false;
					} else if(Integer.parseInt(getInputSequence()) == 0 || getInputSequence().equals("00000000")){
						...
						displayArea.setText("<html> You have deposited Rp." + getInputSequence() 
						+ "! <br><br>" + finishedTransaction() + "</html>");
						System.out.println("User Has Deposited Rp." + getInputSequence());
						updateTransactionHist("User Has Deposited Rp." + getInputSequence());
					}
					clearInput();
					inputDisplay.setText("Input Display: ");
					readyToEnter = false;
	...
	String finishedTransaction(){
		return "Instruction Area: <br> Please select a function from the buttons below <br> Current Balance: Rp." + balance;
	}
